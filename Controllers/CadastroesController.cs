...
namespace CrudCadastroAluno.Controllers
{
    public class CadastroesController : Controller
    {
        private readonly Contexto _context;

        public CadastroesController(Contexto context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Email,Telefone")] Cadastro cadastro)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Email,Telefone")] Cadastro cadastro)
        {
            if (id != cadastro.Id)
            {
                return NotFound();
